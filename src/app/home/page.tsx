                    ...
                    <div className="h-full ">
                        ...
                        <div className="w-8/12 ml-20 flex flex-row  ">
                            <div className="m-5  ml-10 relative text-center ">
                                ...
                                <p className="text-3xl font-bold mt-3 ml-10">
                                    Easy Ordering: Select your address and place an order in minutes- no hassle, just
                                    convenience.
                                </p>
                            </div>
                            <div className=" ">
                                <Image className="relative m-5 mt-10" src={bgCylinder} alt={"bgCylinder"} width={400}/>
                            </div>
